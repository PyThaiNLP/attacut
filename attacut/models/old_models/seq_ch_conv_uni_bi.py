...
class Model(CharacterSeqBaseModel):
    ...
    def forward(self, inputs):
        ...
        conv_uni = self.dropout(self.conv_uni(embedding).permute(0, 2, 1))
        conv_bi = self.dropout(self.conv_bi(embedding)[:, :, :-1].permute(0, 2, 1))
        ...
        out = torch.stack((conv_uni, conv_bi, conv1, conv2, conv3), 3)
